...
// node_modules/react-trend/es/components/Trend/Trend.js
var import_react = __toESM(require_react());
var import_prop_types = __toESM(require_prop_types());

// node_modules/react-trend/es/utils/index.js
...
// node_modules/react-trend/es/helpers/math.helpers.js
var normalize = function normalize2(_ref) {
  var value = _ref.value, min = _ref.min, max = _ref.max, _ref$scaleMin = _ref.scaleMin, scaleMin = _ref$scaleMin === void 0 ? 0 : _ref$scaleMin, _ref$scaleMax = _ref.scaleMax, scaleMax = _ref$scaleMax === void 0 ? 1 : _ref$scaleMax;
  if (min === max) {
    return scaleMin;
  }
  return scaleMin + (value - min) * (scaleMax - scaleMin) / (max - min);
};
var moveTo = function moveTo2(to, from, radius) {
...
var getDistanceBetween = function getDistanceBetween2(p1, p2) {
  return Math.sqrt(Math.pow(p2.x - p1.x, 2) + Math.pow(p2.y - p1.y, 2));
};
var checkForCollinearPoints = function checkForCollinearPoints2(p1, p2, p3) {
  return (p1.y - p2.y) * (p1.x - p3.x) === (p1.y - p3.y) * (p1.x - p2.x);
};

// node_modules/react-trend/es/helpers/DOM.helpers.js
var buildLinearPath = function buildLinearPath2(data) {
...
var buildSmoothPath = function buildSmoothPath2(data, _ref2) {
  var radius = _ref2.radius;
  var firstPoint = data[0], otherPoints = data.slice(1);
...
// node_modules/react-trend/es/helpers/misc.helpers.js
var generateId = function generateId2() {
  return Math.round(Math.random() * Math.pow(10, 16));
};

// node_modules/react-trend/es/components/Trend/Trend.helpers.js
var normalizeDataset = function normalizeDataset2(data, _ref) {
  var minX = _ref.minX, maxX = _ref.maxX, minY = _ref.minY, maxY = _ref.maxY;
  ...
  if (boundariesY.min === boundariesY.max) {
    normalizedData[0].y += 1e-4;
  }
  return normalizedData;
};
var generateAutoDrawCss = function generateAutoDrawCss2(_ref2) {
  var id = _ref2.id, lineLength = _ref2.lineLength, duration = _ref2.duration, easing = _ref2.easing;
...
var propTypes = {
  data: import_prop_types.default.arrayOf(import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.shape({
    value: import_prop_types.default.number
  })]).isRequired).isRequired,
  smooth: import_prop_types.default.bool,
  autoDraw: import_prop_types.default.bool,
  autoDrawDuration: import_prop_types.default.number,
  autoDrawEasing: import_prop_types.default.string,
  width: import_prop_types.default.number,
  height: import_prop_types.default.number,
  padding: import_prop_types.default.number,
  radius: import_prop_types.default.number,
  gradient: import_prop_types.default.arrayOf(import_prop_types.default.string)
};
var defaultProps = {
  radius: 10,
  stroke: "black",
...
var Trend = function(_Component) {
  ...
  Trend2.prototype.componentDidMount = function componentDidMount() {
    var _props = this.props, autoDraw = _props.autoDraw, autoDrawDuration = _props.autoDrawDuration, autoDrawEasing = _props.autoDrawEasing;
    if (autoDraw) {
  ...
  Trend2.prototype.getDelegatedProps = function getDelegatedProps() {
    return omit(this.props, Object.keys(propTypes));
  };
  Trend2.prototype.renderGradientDefinition = function renderGradientDefinition() {
  ...
  Trend2.prototype.render = function render() {
    var _this2 = this;
    var _props2 = this.props, data = _props2.data, smooth = _props2.smooth, width = _props2.width, height = _props2.height, padding = _props2.padding, radius = _props2.radius, gradient = _props2.gradient;
    ...
    var path = smooth ? buildSmoothPath(normalizedValues, { radius }) : buildLinearPath(normalizedValues);
    return import_react.default.createElement(
      "svg",
      _extends2({
        width: svgWidth,
      ...
      import_react.default.createElement("path", {
        ...
        d: path,
        fill: "none",
        stroke: gradient ? "url(#" + this.gradientId + ")" : void 0
      })
    );
  };
  return Trend2;
}(import_react.Component);
true ? Trend.propTypes = propTypes : void 0;
Trend.defaultProps = defaultProps;
var Trend_default = Trend;
export {
  Trend_default as default
};
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=react-trend.js.map
